...
router.get('/getWhatIBide',isActiveUser, controller.getWhatIBide);
router.get('/getName', controller.getName);
router.post('/create',upload.single("image"), controller.create);
router.post('/createForInside/:id',isActiveUser,upload.single("image"), controller.createForInside);
