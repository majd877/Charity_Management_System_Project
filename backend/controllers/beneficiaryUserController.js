...
const create = async (req, res, next) => {
  ...
  try {
    ...
    other.image= file.path.replace("uploads\\", "");
        ...
        const representative = await BeneficiaryUserModel.create(other);
...
const representative = await BeneficiaryUserModel.findByIdAndUpdate(
      params,
      { $set: other },
...
const deleteData = async (req, res, next) => {
  ...
  try {
    ...
    const representative = await BeneficiaryUserModel.findById(params);
...
const get = async (req, res, next) => {
  try {
   ...
   const representatives = await BeneficiaryUserModel.aggregate(pipeline);

   
   const total = await BeneficiaryUserModel.countDocuments(searchFilter);
