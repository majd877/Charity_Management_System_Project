...
const SignIn: React.FC = () => {
 ...
 const handleErrorRes = (error: any) => {
  ...
  return (
    <>
      <div className="rounded-sm border border-stroke h-[100vh] bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center h-full">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block " to="/">
                <img className="hidden dark:block w-96 h-80" src={Logo} alt="Logo" />
                <img className="dark:hidden w-96 h-80" src={Logo} alt="Logo" />
              </Link>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Start work now</span>
    ...
    />
            ...
            className={`flex mt-6 w-2/5 mx-auto  justify-center rounded bg-green-500 p-3 font-medium text-gray hover:bg-opacity-90`}
                to={"/RequestAsEmployee"}>طلب أنضمام كموظف</NavLink>
                   <NavLink
            className={`flex mt-6 w-2/5 mx-auto  justify-center rounded bg-red p-3 font-medium text-gray hover:bg-opacity-90`}
                to={"/RequestAsDonors"}>طلب أنضمام كمتبرع</NavLink>
                   <NavLink
            className={`flex mt-6 w-2/5 mx-auto  justify-center rounded bg-blue-500 p-3 font-medium text-gray hover:bg-opacity-90`}
                to={"/RequestAsBeneficiary"}>طلب أنضمام كمستفيد</NavLink>
            </div>
          </div>
        </div>
      </div>
      {error&&<AlertError data={{title:"error",message:"login error"}}/>}
