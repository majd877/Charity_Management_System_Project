...
const { data, isLoading, isError, refetch } = useGetQueryApiQuery({
  ...
  if (openCreate) {
    return (
      <CreateDialog
        data={create}
        title="انشاء استفسارات المتبرعين"
        endPoint="ComplaintsDonors/create"
  ...
  if (openDelete !== null) {
    return (
      <CreateDialog
        data={[]}
        title={`حذف استفسارات المتبرعين`}
        endPoint={`ComplaintsDonors/delete/${openDelete}`}
  ...
  if (openEdit !== null) {
    return (
      <CreateDialog
        data={edit}
        title="تعديل استفسارات المتبرعين"
        endPoint={`ComplaintsDonors/update/${openEdit}`}
  ...
  return (
    <>
      <Tables
        ...
        endPoint="ComplaintsDonors/getByUser"
        title="استفسارات المتبرعين"
       accessKeys={[
...
export default ComplaintsDonorsUser;