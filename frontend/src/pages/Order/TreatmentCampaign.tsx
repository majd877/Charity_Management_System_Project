...
const { data, isLoading, isError, refetch } = useGetQueryApiQuery({
  ...
  if (openCreate) {
    return (
      <CreateDialog
        data={create}
        title="Create TreatmentCampaign"
        endPoint="TreatmentCampaign/create"
  ...
  if (openDelete !== null) {
    return (
      <CreateDialog
        data={[]}
        title={`Delete TreatmentCampaign ${deleteSelected}`}
        endPoint={`TreatmentCampaign/delete/${openDelete}`}
  ...
  if (openEdit !== null) {
    return (
      <CreateDialog
        data={edit}
        title="Edit TreatmentCampaign"
        endPoint={`TreatmentCampaign/update/${openEdit}`}
  ...
  return (
    <>
      <Tables
        ...
        endPoint="TreatmentCampaign/get"
        title="حملات العلاجية"
       accessKeys={[
...
export default TreatmentCampaign;